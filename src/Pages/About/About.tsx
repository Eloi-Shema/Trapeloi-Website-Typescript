    ...
    <main className="m-auto max-w-[1536px] flex flex-col gap-8 dark:text-white text-black xs:text-base md:text-lg dark:bg-black bg-platinum xs:py-10 md:py-16 xs:px-8 md:px-20 font-montserrat">
      ...
      <div>
        ...
        <p>
          ...
          worldwide. Our goal is to help musicians bring their creative visions
          to life with professionally crafted HipHop/Pop instrumentals.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc pl-8 leading-8 mb-5">
          ...
          <li>
            ...
            Need a tailored instrumental? We offer custom beat production to fit
            your creative needs.
          </li>
          <li>
            <span className="font-bold font-montserrat">
      ...
      <div>
        ...
        <p className="mb-5">
          ...
          we invite you to explore our beat catalog and bring your next project
          to hits.
        </p>
        ...
        <p className="mt-2">
          For direct inquiries, custom requests, or collaborations, feel free to
          contact us at:&nbsp;
